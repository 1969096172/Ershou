...
public class constrain extends AppCompatActivity{
    ...
    Button[] number_bt=new Button[13];//用来接收从界面获取的数字按钮
    ...
    void initView(){
        ...
        number_bt[11]=findViewById(R.id.left);
        number_bt[12]=findViewById(R.id.right);
    ...
    void setEvent(){
        constrain.NumberClickListener numberClickLiatener=new constrain.NumberClickListener();//实例化对象
...
//        }
        ...
        constrain.OperatorClickListener operatorClickListener=new constrain.OperatorClickListener();
        ...
        delete_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String laststr = resultstr.substring(resultstr.length()-1,resultstr.length());//截取字符串
    ...
    class NumberClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if(firstFlag){
                ...
                if(lastCommand.equals("")){
                    if (numb1.contains(".")&&inputstr.equals(".")){//如果当前输入已经包含.并且现在输入.则不响应
                        return;
                    }
